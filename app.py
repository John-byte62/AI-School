...
def main():
    ...
    with st.beta_expander(label ='Python Operators '):
        ...
        st.image(path+'/bit.JPG',width=600,use_column_width=False)
        st.write("")
        ...
        st.image(path+'/assign.JPG',width=600,use_column_width=False)
        st.write("")
        ...
        st.image(path+'/iden.JPG',width=600,use_column_width=False)
        ...
        st.image(path+'/mem.JPG',width=600,use_column_width=False)
    ...
    with st.beta_expander(label ='Python Flow Controls'):
        ...
        st.image(path+'/ifelse.JPG',width=600,use_column_width=False)
        ...
        st.image(path+'/nestedif.JPG',width=600,use_column_width=False)
        ...
        st.image(path+'/forloop.JPG',width=600,use_column_width=False)
        ...
        st.image(path+'/forelse.JPG',width=300,use_column_width=False)
        ...
        st.image(path+'/while.JPG',width=600,use_column_width=False)
        ...
        st.image(path+'/whileelse.JPG',width=600,use_column_width=False)
    ...
    with st.beta_expander(label ='Python Functions'):
        ...
        st.image(path+'/func.JPG',width=300,use_column_width=False)
        ...
        st.image(path+'/func_return.JPG',width=500,use_column_width=False)
        ...
        st.image(path+'/lamba.JPG',width=500,use_column_width=False)
    ...
    with st.beta_expander("Neurons"):
        ...
        st.image(path+'/neuron.JPG',width=300,use_column_width=False)
    ...
    with st.beta_expander("Networks of Neurons"):
        ...
        st.image(path+'/nn.JPG',width=300,use_column_width=False)
    ...
    st.write("")
    st.write("")
    st.image(path+'/end.JPG',width=800,use_column_width=False)
    st.write("**----------------------------------------------------------END----------------------------------------------------------**")
