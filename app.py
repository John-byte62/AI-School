...
def main():
    ...
    with st.beta_expander(label ='Python Variables and Datatypes.'):
        ...
        st.image(Image.open('tuples.JPG'),width=500,use_column_width=False)
        st.write("")
        st.write("**Python Set**")
        ...
        st.image(Image.open('set.JPG'),width=500,use_column_width=False)
        st.write("")
        ...
        st.image(Image.open('dict.JPG'),width=500,use_column_width=False)
    ...
    with st.beta_expander(label ='Python Operators '):
        ...
        st.image(Image.open('arith.JPG'),width=600,use_column_width=False)
        st.write("")
        ...
        st.image(Image.open('comp.JPG'),width=600,use_column_width=False)
        st.write("")
        st.write("**Logical operators**")
        st.write('Logical operators are the and, or, not operators.')
        st.image(Image.open('log.JPG'),width=600,use_column_width=False)
        st.write("")
        ...
        st.image(Image.open('bit.JPG'),width=600,use_column_width=False)
        st.write("")
        ...
        st.image(Image.open('assign.JPG'),width=600,use_column_width=False)
        st.write("")
        ...
        st.image(Image.open('iden.JPG'),width=600,use_column_width=False)
        ...
        st.image(Image.open('mem.JPG'),width=600,use_column_width=False)
    ...
    with st.beta_expander(label ='Python Flow Controls'):
        ...
        st.image(Image.open('flowchartif.JPG'),width=600,use_column_width=False)
        st.write("**Example of if...elif...else**")
        st.image(Image.open('ifelse.JPG'),width=600,use_column_width=False)
        ...
        st.image(Image.open('nestedif.JPG'),width=600,use_column_width=False)
        ...
        st.image(Image.open('forloop.JPG'),width=600,use_column_width=False)
        ...
        st.image(Image.open('forelse.JPG'),width=300,use_column_width=False)
        ...
        st.image(Image.open('while.JPG'),width=600,use_column_width=False)
        ...
        st.image(Image.open('whileelse.JPG'),width=600,use_column_width=False)
    ...
    with st.beta_expander(label ='Python Functions'):
        ...
        st.image(Image.open('func.JPG'),width=300,use_column_width=False)
        ...
        st.image(Image.open('func_return.JPG'),width=500,use_column_width=False)
        ...
        st.image(Image.open('lamba.JPG'),width=500,use_column_width=False)
    ...
    with st.beta_expander("Neurons"):
        ...
        st.image(Image.open('neuron.JPG'),width=300,use_column_width=False)
    ...
    with st.beta_expander("Networks of Neurons"):
        ...
        st.image(Image.open('nn.JPG'),width=300,use_column_width=False)
